...
\begin{center}
	\begin{tikzpicture}
		...
		\begin{axis}[
			...
			ymin=\ymin-0.5,
			ymax=\ymax+0.5]
			\node[label={270:{$-2$}},circle,draw=blue,line width=1mm,inner sep=0pt,minimum size=1mm] at(-2,0){};
			\node[label={270:{$2$}},circle,draw=blue,line width=1mm,inner sep=0pt,minimum size=1mm] at(2,0){};
			\node[label={270:{$-1$}},circle,draw=blue,line width=1mm,inner sep=0pt,minimum size=1mm] at(-1,0){};
			\node[single arrow,draw,fill=red,minimum height=0mm,minimum width=0mm,inner sep=0pt,single arrow head extend=1.5mm] at(2.65,0){};
			\node[single arrow,left,draw,fill=red,minimum height=0mm,minimum width=0mm,inner sep=0pt,single arrow head extend=1.5mm,shape border rotate=180] at(0.5,0){};
			\node[single arrow,left,draw,fill=red,minimum height=0mm,minimum width=0mm,inner sep=0pt,single arrow head extend=1.5mm,shape border rotate=180] at(-1.55,0){};
			\node[single arrow,left,draw,fill=red,minimum height=0mm,minimum width=0mm,inner sep=0pt,single arrow head extend=1.5mm,shape border rotate=180] at(-2.55,0){};
		\end{axis}
	\end{tikzpicture}
\end{center}
\end{document}