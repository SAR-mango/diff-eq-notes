...
Critical points at $y = -3$, $y = 0$, and $y = 2$.

$y = -3$ is unstable, $y = 0$ is stable, and $y = 2$ is semi-stable.
...
Let's do a more comprehensive example. For the differential equation below, determine all equilibrium points and classify them by their stability. Draw a phase line to represent your answer:
$$$$
