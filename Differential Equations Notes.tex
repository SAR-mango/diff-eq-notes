...
Notice that $y'$ (the slope of any solution) is zero at $y = 2$, $y = -2$, and $y = -1$. These points are known as \textbf{equilibrium solutions} as they will never change once they are reached – the slope remains zero.

This raises an important question, however. What if we are stuck on an equilibrium solution and we receive a slight nudge upwards or downwards?
