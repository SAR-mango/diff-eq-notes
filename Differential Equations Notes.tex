	...
	\begin{center}
		\begin{tikzpicture}[scale=1.625]
			...
			\begin{axis}[
				...
				ymin=\ymin-0.5,
				ymax=\ymax+0.5]
				\foreach \n in {\ymin,-2.66666666667,...,\ymax}
				\addplot[blue,quiver={u={1/sqrt(1+((-4 + y^2)*((y+1)^2))^2)},v={((-4 + y^2)*((y+1)^2))/sqrt(1+((-4 + y^2)*((y+1)^2))^2)},scale arrows=0.3},->,samples=2*\xmax + 1,]{\n};
			\end{axis}
		\end{tikzpicture}
	\end{center}
