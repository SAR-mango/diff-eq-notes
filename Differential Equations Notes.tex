...
\begin{center}
	\begin{tikzpicture}
		...
		\begin{axis}[
			...
			\node[single arrow,draw,fill=black,minimum height=0mm,minimum width=0mm,inner sep=0pt,single arrow head extend=1.5mm,direction=left] at(2.65,0){};
			\node[single arrow,left,draw,fill=black,minimum height=0mm,minimum width=0mm,inner sep=0pt,single arrow head extend=1.5mm] at(1.35,0){};
		\end{axis}
	\end{tikzpicture}
\end{center}
\end{document}