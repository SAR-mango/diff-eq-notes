...
\begin{center}
	\begin{tikzpicture}
		...
		\begin{axis}[
			...
			\node[single arrow,left,draw,fill=black,minimum height=0mm,minimum width=0mm,inner sep=0pt,single arrow head extend=1.5mm,shape border rotate=180] at(1.35,0){};
			\node[single arrow,left,draw,fill=black,minimum height=0mm,minimum width=0mm,inner sep=0pt,single arrow head extend=1.5mm,shape border rotate=180] at(-0.35,0){};
			\node[single arrow,left,draw,fill=black,minimum height=0mm,minimum width=0mm,inner sep=0pt,single arrow head extend=1.5mm,shape border rotate=180] at(-1.65,0){};
		\end{axis}
	\end{tikzpicture}
\end{center}
\end{document}