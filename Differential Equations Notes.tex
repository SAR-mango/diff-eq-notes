...
\begin{center}
	\begin{tikzpicture}
		...
		\begin{axis}[
			...
			\node [single arrow,draw,fill=red,
			minimum height=5mm,minimum width=1mm,
			inner sep=0pt,%<--- now the width should be as you expected
			single arrow head extend=1mm] {};%<-- smaller arrow (it
			doesn't work!)
		\end{axis}
	\end{tikzpicture}
\end{center}
