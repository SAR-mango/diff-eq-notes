...
With all of this in mind, let's do an example. Using the information from the phase line below, determine all critical points and indicate their stability:
...
\begin{center}
	\begin{tikzpicture}
		...
		\begin{axis}[
			...
			\node[single arrow,left,draw,fill=black,minimum height=0mm,minimum width=0mm,inner sep=0pt,single arrow head extend=1.5mm,shape border rotate=180] at(0.8,0){};
			\node[single arrow,left,draw,fill=black,minimum height=0mm,minimum width=0mm,inner sep=0pt,single arrow head extend=1.5mm] at(-1.55,0){};
		\end{axis}
	\end{tikzpicture}
\end{center}
\end{document}