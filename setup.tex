...
\usepackage[usenames,dvipsnames]{xcolor}	% for coloring and highlighting text
...
\renewcommand{\cfttoctitlefont}{\section*}
...
\titleformat{\section}{\normalfont\scshape}{\color{Mahogany}\textbf\thesection}{0em{\textbf{\color{Mahogany}{ – }}}}{\color{Mahogany}\textbf}
\titleformat{\subsection}{\normalfont\scshape}{\color{magenta}\thesubsection}{0em{\color{magenta}{: }}}{\color{magenta}\textnormal}
